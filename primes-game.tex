...
The game ends when a player gets to 100, when no player has any cards left to play, or after a specified time limit. The winner is the player whose token is furthest ahead.
