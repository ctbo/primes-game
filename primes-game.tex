...
\newcommand{\largecard}[1]{\adjustbox{valign=m}{\includegraphics[page=#1, width=37mm]{primecards-screen.pdf}}}
...
When a player gets to 100, they win the game. If the deck runs out before that, the \textbf{endgame} starts: after each turn, if a player is in the last position, they quit the game and remove their token. The winner is the player that remains at the end.
